...
你收到的数据包括: K线走势、技术指标、基本面、资金流向(主力/散户/北向)、融资融券、
涨跌停统计、风险指标(VaR/CVaR/最大回撤/Sharpe)、恐贪指数、市场状态。请充分利用。\n\n"""
...
裁决要有主见, 不是简单平均。特别重视: 魔鬼代言人的盲点 + 情绪猎手的资金信号。
"""
...
def build_prompt(stock_name, ts_code, df, fina, business, news_text,
                 risk_text, sentiment_text, akshare_text):
    latest = df.iloc[-1]
    kline_lines = []
...
def main():
    ...
    st.caption("5 Agent辩论 · CoT推理 · 风险量化 · 情绪分析 · 资金流向")
    ...
    if not analyze_btn or not stock_code:
        ...
        <div class="landing-grid">
            ...
            <div class="landing-card"><h4>🧠 情绪+资金</h4><p>恐贪指数 · 北向资金 · 主力流向<br>融资融券 · 涨跌停 · 市场状态</p></div>
            <div class="landing-card"><h4>🎭 5人辩论</h4><p>趋势·价值·魔鬼代言人·短线·情绪<br>CoT推理 · 首席策略官裁决</p></div>
